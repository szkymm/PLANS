...
def _init_build_parser_function_():
    ...
    argument_parser = argparse.ArgumentParser(
        ...
        description=(
            ...
            "Usage: PLANS [--db PATH] <project> <command> [<args>...]\n\n"
            "The project name resolves to {COMMON_PLANS_DB}/<project>.db\n"
            "automatically. Use --db for an explicit file path.\n\n"
            "Available commands:\n"
            "  init              Initialize the PLANS database schema\n"
            "  strack create     Create a new Strack container\n"
            "  strack list       List all Stracks\n"
            "  strack show       Show details of a Strack\n"
            "  strack delete     Delete a Strack\n"
            "  plan create       Create a new Plan (todo) under a Strack\n"
            "  plan list         List Plans, optionally filtered by Strack\n"
            "  plan show         Show details of a Plan\n"
            "  plan update       Update the status of a Plan\n"
            "  plan delete       Delete a Plan\n"
            "  issue create      Create a new Issue under a Strack\n"
            "  issue list        List Issues, optionally filtered by Strack\n"
            "  issue show        Show details of an Issue\n"
            "  issue update      Update the status of an Issue\n"
            "  issue delete      Delete an Issue\n"
            "  action create     Create a new Action under a Strack\n"
            "  action list       List Actions, optionally filtered by Strack\n"
            "  action show       Show details of an Action\n"
            "  action update     Update the status of an Action\n"
            "  action delete     Delete an Action\n"
            "  note create       Create a new Note under a Strack\n"
            "  note list         List Notes, optionally filtered by Strack\n"
            "  note show         Show details of a Note\n"
            "  note update       Update the title or content of a Note\n"
